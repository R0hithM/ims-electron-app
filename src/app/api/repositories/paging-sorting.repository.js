...
class PagingSortingRepository {
    constructor(entity) {
        this.entity = entity;
    }
    getEntitiesWithPagingAndSorting(pagingAndSortingOptions, whereCondition) {
        return __awaiter(this, void 0, void 0, function* () {
            const repo = db_1.default.getRepository(this.entity);
            const [entityResult, entityCount] = yield Promise.all([
                repo.find({
...
exports.default = PagingSortingRepository;
