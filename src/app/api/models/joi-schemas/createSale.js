...
/**
 * @description Joi Schema for createSale route
 */
class CreateSale {
    /**
     * @description To generate schema
     * @return {Joi.Schema} Joi Schema for createSale route
     */
    static schema() {
        return joi_1.default.object({
            ...
            dueDate: joi_1.default.string().allow('').allow(null),
            estimationId: joi_1.default.string().allow('').allow(null),
            isCreditNoteApplied: joi_1.default.boolean().required()
        }).unknown(false);
    }
}
