...
let TestRepository = class TestRepository extends paging_sorting_repository_1.default {
    constructor() {
        super(testData_1.TestData);
        this.testDataRepo = db_1.default.getRepository(testData_1.TestData);
    }
    getTestDataWithPagingAndSorting(pagingAndSortingOptions) {
